    ...
    public static final class Formatting extends Section {
        ...
        public static final class DiscordFormatting extends Section {
            ...
            public static final class WebhookFormatting extends Section {
                ...
                @Comment("Additional placeholders: <skin_id> <skin_model> <uuid>")
                public final TrackedValue<String> avatar_url = value("https://visage.surgeplay.com/bust/128/<skin_id>?<skin_model>");
                ...
                @Comment("Default skin model for the webhook's avatar, if the player's cannot be loaded")
                public final TrackedValue<String> default_skin_model = value("wide");
